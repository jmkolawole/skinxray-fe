...
const Landing = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Skinxray AI - Advanced Skin Health Diagnostics</title>
        <meta name="description" content="Get instant AI-powered analysis of your skin conditions. Upload an image or describe your symptoms for personalized insights." />
      </Helmet>
      <S.Container>
        <S.HeroSection>
          <S.HeroContent>
